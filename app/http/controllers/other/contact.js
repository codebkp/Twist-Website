"use strict";
Application.Servers.Website.get('/contact', Application.Servers.Website.group('user'), function (request, result) {
    result.end(result.render('views/footer/contact', { page : 'Contact Us'}));
});
